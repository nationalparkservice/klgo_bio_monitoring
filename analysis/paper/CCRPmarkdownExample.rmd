...
```{r Fig-SpeciesTiming2, echo=FALSE, eval=FALSE, cache=TRUE, fig.show= 'asis', fig.height=25, fig.width=12, fig.cap="For each of the target species, the dates on which they were observed in any of the sample areas."}
