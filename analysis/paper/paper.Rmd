...
# Issues to Resolve
- why isn't code chunk option warning= FALSE suppressing warnings() in Data_Retrieval? (from read_csv)
...
- conversion from paper.md to paper.pdf (pandoc issue?) (i) update MikTex package, set dev=c('pdf') in setup
...
```{r EDA_SurveyTiming, eval=TRUE, cache = FALSE, fig.show= 'asis'}
