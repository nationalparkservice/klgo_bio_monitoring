...
abstract: The Coastal Waterbird Survey has been conducted, with varying levels of
  ...
  and assess how things are going. We review the current survey programâ€™s objectives,  design,
  identify statistical issues, and recommend potential solutions. Major topics include
  â€¦. The study concludes with a series of recommended tasks that the park should
  undertake to improve the coastal waterbird surveyâ€™s efficiency and effectiveness.
---
...
library(dplyr);library(ggplot2);library(dbplyr);library(readr)
