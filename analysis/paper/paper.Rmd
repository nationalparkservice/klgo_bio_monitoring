...
# scatterplot of species' first and last sightings
...
```{r Fig-SurveyDates2, echo=FALSE, eval=TRUE, cache=TRUE, fig.show= 'asis', fig.cap="The last sighting of each species each year."}
print(plot_timing_2)
```
