...
```{r SurveySites, eval=TRUE, cache = FALSE, include = FALSE}
# dotplot of survey occurrences by unit and whether there were observations
source("../scripts/survey_sites.R", echo=FALSE)
```


```{r Fig-SurveySites, echo=FALSE, eval=TRUE, cache=TRUE, fig.show= 'asis', fig.cap="The annual dates of the first and last survey have both varied by over a month across the years."}
...
```{r Fig-SurveyDates1, echo=FALSE, eval=TRUE, cache=TRUE, fig.show= 'asis', fig.cap="The first sighting of each species each year."}
print(plot_timing_1)
```
