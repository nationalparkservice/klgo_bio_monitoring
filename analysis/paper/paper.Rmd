...
# Issues to Resolve
- How do we use latex figure environment in rmarkdown (for inclusion of ggplot graphics; captioning figures and labelling for cross-references, etc)?
- conversion from paper.md to paper.pdf (pandoc issue?) 
  (i) update MikTex package, set dev=c('pdf') in setup
- github permissions for Madeleine on local machine
...
```{r Data_Retrieval, eval=TRUE, echo=FALSE, warning = FALSE}
...
The annual dates of the first and last survey each year has varied by over a month (Figure \ref{fig:Figure_SurveyTiming}).

```{r EDA_SurveyTiming, eval=TRUE, cache = TRUE, include = FALSE}
# dotplot of survey times by year
source("../scripts/survey_timing_EDA.R", echo=FALSE)

```

```{r Figure_SurveyTiming, echo=FALSE, eval=TRUE, cache=TRUE, dependson= c("EDA_SurveyTiming"), fig.show= 'asis', fig.cap="\\label{fig:Figure_SurveyTiming}The annual dates of the first and last survey have both varied by over a month across the years."}
