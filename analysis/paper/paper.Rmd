...
library(dplyr);library(ggplot2);library(dbplyr);library(readr);library(stringr);library(tidyr);library(lubridate);library(ggthemes);library(ggforce)
...
print(getwd())
#source("./analysis/scripts/data_retrievalCSV.R")
source("../scripts/data_retrievalCSV.R") #JR added 2019 Feb 5, need '..' to reference relative parent directory.
...
```{r, eval=TRUE}
#source("./analysis/scripts/data_exploration.R")
source("../scripts/data_exploration.R") # JR 2019 Feb 5 corrected relative pathname

#source("../scripts/units_species.R")
```
